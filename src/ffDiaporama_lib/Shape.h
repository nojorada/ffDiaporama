...
enum SHAPEFORM_ID {
    ...
    //SHAPEFORM_PUZZLEUR_NEW,SHAPEFORM_PUZZLEMR_NEW,SHAPEFORM_PUZZLEDR_NEW,
...
class cShapeFormDefinition 
{
   public:
      ...
      double          RatioX;
      double          RatioY;
      QRectF          MarginRect() { return QRectF(TMx,TMy,TMw,TMh); }
      cShapeFormDefinition() { RatioX = RatioY = -1.0; }
...
QList<QPolygonF>    ComputePuzzle(QRectF Rect,int Forme/*, bool isRight=false*/);
