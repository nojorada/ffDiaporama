...
#define pAppConfig  cBaseAppConfig::pAppCfg();

class cLuLoImageCache;
class cBaseAppConfig : public QObject 
{
   Q_OBJECT
      static cBaseAppConfig* baseAppConfig;
   public:
      bool              Smoothing;           // True do smoothing in preview
      Qt::TransformationMode smoothing() { return Smoothing ? Qt::SmoothTransformation : Qt::FastTransformation; }
      ...
      cBaseAppConfig() = delete;
      cBaseAppConfig(cBaseAppConfig const&) = delete;
      cBaseAppConfig& operator=(cBaseAppConfig const&) = delete;
      cBaseAppConfig(cBaseAppConfig&&) = delete;
      cBaseAppConfig& operator=(cBaseAppConfig&&) = delete;
      virtual ~cBaseAppConfig();

      bool initDatabase(const QString dbPath);
      static cBaseAppConfig* pAppCfg() { return baseAppConfig; }
};
