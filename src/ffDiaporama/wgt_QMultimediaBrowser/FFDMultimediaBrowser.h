...
#ifndef FFDMULTIMEDIABROWSER_H
#define FFDMULTIMEDIABROWSER_H
...
namespace Ui {
    class FFDMultimediaBrowser;
}

class FFDMultimediaBrowser : public QWidget 
{
   Q_OBJECT
   public:
      ...
      explicit FFDMultimediaBrowser(QWidget *parent = 0);
      ~FFDMultimediaBrowser();
...
private:
   Ui::FFDMultimediaBrowser *ui;
   QStringList FileList;

};

#endif // FFDMULTIMEDIABROWSER_H
