...
void DlgChapter::DoInitDialog() {
    ...
    ui->ChapterEventDateED->setDate(CurrentSlide->OverrideProjectEventDate ? CurrentSlide->ChapterEventDate : CurrentSlide->getDiaporama()->ProjectInfo()->EventDate());
    ui->ChapterDateED->setPlainText(CurrentSlide->OverrideProjectEventDate ? CurrentSlide->OverrideChapterLongDate ? CurrentSlide->ChapterLongDate : FormatLongDate(CurrentSlide->ChapterEventDate) : CurrentSlide->getDiaporama()->ProjectInfo()->LongDate());
...
bool DlgChapter::DoAccept() {
    ...
    CurrentSlide->ChapterEventDate          =CurrentSlide->OverrideProjectEventDate?ui->ChapterEventDateED->date():CurrentSlide->getDiaporama()->ProjectInfo()->EventDate();
    CurrentSlide->ChapterLongDate           =CurrentSlide->OverrideProjectEventDate?CurrentSlide->OverrideChapterLongDate?ui->ChapterDateED->toPlainText():FormatLongDate(CurrentSlide->ChapterEventDate):CurrentSlide->pDiaporama->ProjectInfo()->LongDate();

    if (IsLocationChanged) CurrentSlide->getDiaporama()->UpdateGMapsObject();
